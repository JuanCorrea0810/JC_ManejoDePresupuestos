...
namespace ManejoDePresupuestos.Migrations
{
    ...
    [Migration("20230227145051_TransaccionesPorSemana")]
    partial class TransaccionesPorSemana
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ManejoDePresupuestos.Models.Categoria", b =>
                {
                    ...
                    b.ToTable("Categorias", t =>
                        {
                            t.HasTrigger("Categorias_Trigger");
                        });
                });
            ...
            modelBuilder.Entity("ManejoDePresupuestos.Models.TipoCuenta", b =>
                {
                    ...
                    b.ToTable("TipoCuentas", t =>
                        {
                            t.HasTrigger("TipoCuentas_Trigger");
                        });
                });
            ...
            modelBuilder.Entity("ManejoDePresupuestos.Models.TipoOperacion", b =>
                {
                    ...
                    b.ToTable("TiposOperaciones", t =>
                        {
                            t.HasTrigger("TiposOperaciones_Trigger");
                        });
                });
            ...
            modelBuilder.Entity("ManejoDePresupuestos.Models.Transaccion", b =>
                {
                    ...
                    b.ToTable("Transacciones", t =>
                        {
                            t.HasTrigger("Transacciones_Trigger");
                        });
                });
